odoo.define('report_general_travel.general_report_generic', function (require) {
'use strict';
...
var ReportWidget = require('report_general_travel.ReportWidget');
...
var general_report_generic = Widget.extend(ControlPanelMixin, {
    ...
    get_html: function() {
        ...
        var self = this;
        var defs = [];
        return new Model('tms.report.context.common').call('return_context', [self.report_model, self.given_context, self.report_id]).then(function (result) {
    ...
    render_buttons: function() {
        var self = this;
        this.$buttons = $(QWeb.render("tmsReports.buttons", {xml_export: this.xml_export}));
    ...
    render_searchview_buttons: function() {
        ...
        this.$searchview_buttons = $(QWeb.render("tmsReports.searchView", {report_type: this.report_type, context: this.report_context}));
    ...
    onChangeCmpDateFilter: function(event, fromDateFilter) {
        ...
        var no_date_range = this.report_type === 'no_date_range' || this.report_type === 'date_range';
...
core.action_registry.add("general_report_generic", general_report_generic);
return general_report_generic;
});
