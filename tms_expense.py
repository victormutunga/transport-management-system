...
class tms_direct_expense(osv.osv):
    ...
    _columns = {
        'agreement_id': openerp.osv.fields.many2one('tms.agreement', 'Agreement', required=False, ondelete='cascade', select=True, readonly=True),
        'automatic_advance': openerp.osv.fields.boolean('Automatic Advance'),
        ...
        'product_id'        : openerp.osv.fields.many2one('product.product', 'Product', domain=[('tms_category', 'in', ('freight','move','highway_tolls','other','real_expense','madeup_expense','salary','fuel','indirect_expense'))]),
...
#######################################################################################        
        ...
        'automatic'         : openerp.osv.fields.boolean('Automatic Advance', help="Check this if you want to create Advances for this line automatically"),
        'credit'            : openerp.osv.fields.boolean('Automatic Fuel', help="Check this if you want to create Fuel Vouchers for this line"),
        'fuel_supplier_id'  : openerp.osv.fields.many2one('res.partner', 'Fuel Supplier', domain=[('tms_category', '=', 'fuel')],  required=False),
        'on_change'         : openerp.osv.fields.boolean('Creado desde el Onchange'),
    }
    _order = 'sequence'
