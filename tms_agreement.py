...
class tms_agreement(osv.Model):
	...
	_columns = {
		...
		'version': openerp.osv.fields.float('Version', digits=(16, 2), readonly=False, select=True),
		'description': openerp.osv.fields.char('Name', size=64, readonly=True, select=True),        
		'date'    : openerp.osv.fields.datetime('Date',required=True, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'shop_id': openerp.osv.fields.many2one('sale.shop', 'Shop', required=True, readonly=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'route_id': openerp.osv.fields.many2one('tms.route', 'Route',states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}, required=True),              
		'route_return_id': openerp.osv.fields.many2one('tms.route', 'Uncharged Route',states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}, required=False),              
		...
		'unit_ids': openerp.osv.fields.many2one('tms.unit.category', 'Unit Category',required=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'units_a': openerp.osv.fields.integer('Units Number',required=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		...
		'travel_wizard': openerp.osv.fields.boolean('Travel Created by Wizard'),
		'currency_id': openerp.osv.fields.many2one('res.currency','Currency',states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}, required=True),
		...
		'hours_start_upload': openerp.osv.fields.float('Start to Upload', digits=(16, 2), required=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'hours_upload_end_upload': openerp.osv.fields.float('Start UpLd to End UpLd', digits=(16, 2), required=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'hours_end_upload_lib_docs': openerp.osv.fields.float('End UpLd to Lib. Docs. UpLd', digits=(16, 2), required=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'hours_lib_docs_prog_download': openerp.osv.fields.float('Lib. Docs. UpLd to Prog DwnLd', digits=(16, 2), required=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'hours_prog_download_start_download': openerp.osv.fields.float('Prog Download to Start DwnLd', digits=(16, 2), required=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'hours_start_download_end_download': openerp.osv.fields.float('Start Download to End DwnLd', digits=(16, 2), required=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'hours_end_download_lib_docs_download': openerp.osv.fields.float('End Download to Lib. Docs. DwnLd', digits=(16, 2), required=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'hours_lib_docs_download_end_travel': openerp.osv.fields.float('Lib. Docs. DwnLd to End Travel', digits=(16, 2), required=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'hours_total_travel': openerp.osv.fields.function(_get_hours_total, string='Total Time for Travel in Hrs.', method=True, type='float', store=True),
		'date_end_calc': openerp.osv.fields.function(_get_date_end, string='Date End', method=True, type='datetime', store=True),
		'date_start_calc': openerp.osv.fields.function(_get_date_start, string='Date Start', method=True, type='datetime', store=True),
		'date_start': openerp.osv.fields.datetime('Date Star', required=False, select=True,readonly=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'date_end': openerp.osv.fields.datetime('Date End', required=False, select=True,readonly=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'agreement_customer_factor': openerp.osv.fields.one2many('factor.quotation', 'agreement_id', 'Agreement Customer Charge Factors', domain=[('category', '=', 'customer')], states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}), 
		'agreement_supplier_factor': openerp.osv.fields.one2many('factor.quotation', 'agreement_id', 'Agreement Supplier Payment Factors', domain=[('category', '=', 'supplier')], states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'agreement_driver_factor': openerp.osv.fields.one2many('factor.quotation', 'agreement_id', 'Agreement Driver Payment Factors', domain=[('category', '=', 'driver')], states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		...
		'origin': openerp.osv.fields.char('Source Document', size=64, help="Reference of the document that generated this agreement request.",readonly=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'client_order_ref': openerp.osv.fields.char('Customer Reference', size=64, readonly=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'state': openerp.osv.fields.selection([('draft','Draft'), ('confirmed','Confirmed'), ('done','Done'), ('cancel','Cancelled')], 'Agreement State', readonly=True, help="Gives the state of the agreement. \n -The exception state is automatically set when a cancel operation occurs in the invoice validation (Invoice Exception) or in the picking list process (Shipping Exception). \nThe 'Waiting Schedule' state is set when the invoice is confirmed but waiting for the scheduler to run on the date 'Ordered Date'.", select=True),
		'user_id': openerp.osv.fields.many2one('res.users', 'Salesman', select=True, readonly=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'partner_id': openerp.osv.fields.many2one('res.partner', 'Customer', required=False, change_default=True, select=True, readonly=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'partner_invoice_id': openerp.osv.fields.many2one('res.partner', 'Invoice Address', required=True, help="Invoice address for current Agreement.", readonly=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'partner_order_id': openerp.osv.fields.many2one('res.partner', 'Ordering Contact', required=True,  help="The name and address of the contact who requested the order or quotation.", readonly=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'departure_address_id': openerp.osv.fields.many2one('res.partner', 'Departure Address', required=True, help="Departure address for current Agreement.", readonly=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'arrival_address_id': openerp.osv.fields.many2one('res.partner', 'Arrival Address', required=True, help="Arrival address for current Agreement.", readonly=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'upload_point': openerp.osv.fields.char('Upload Point', size=128, readonly=False, required=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'download_point': openerp.osv.fields.char('Download Point', size=128, required=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'agreement_line': openerp.osv.fields.one2many('tms.agreement.line', 'agreement_id', 'Agreement Lines', states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'agreement_shipped_product': openerp.osv.fields.one2many('tms.agreement.shipped_product', 'agreement_id', 'Shipped Products', states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'agreement_extradata': openerp.osv.fields.one2many('tms.waybill.extradata', 'agreement_id', 'Extra Data Fields', states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'agreement_direct_expense_line': openerp.osv.fields.one2many('tms.direct.expense', 'agreement_id', 'Expenses Direct', states={'confirmed': [('readonly', False)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'agreement_indirect_expense_line': openerp.osv.fields.one2many('tms.indirect.expense', 'agreement_id', 'Expenses Indirect', states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		...
		'notes': openerp.osv.fields.text('Notes', readonly=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'payment_term': openerp.osv.fields.many2one('account.payment.term', 'Payment Term', readonly=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		'fiscal_position': openerp.osv.fields.many2one('account.fiscal.position', 'Fiscal Position', readonly=False, states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}),
		...
		'distance_route': openerp.osv.fields.function(_get_route_distance, string='Distance (mi./kms)', method=True, type='float', digits=(18,4), help="Route Distance.", store=True),       
		'hours_route': openerp.osv.fields.function(_get_route_hours, string='Travel Time (hrs)',method=True, type='float', digits=(18,4), help="Route Hours.", store=True),
		'amount_declared' : openerp.osv.fields.float('Amount Declared', digits_compute= dp.get_precision('Sale Price'),states={'confirmed': [('readonly', True)],'done':[('readonly',True)],'cancel':[('readonly',True)]}, help=" Load value amount declared for insurance purposes..."),
		...
		'dangerous_shipped': fields.boolean('Carga Peligrosa'),
	}
	_defaults = {
