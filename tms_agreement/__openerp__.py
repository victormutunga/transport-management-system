...
{   
    ...
    "update_xml" : [
                    ...
                    # 'views/crm_case_view.xml',
                    'views/product_demo.xml',
                    'views/product_product_view.xml',
                    'views/res_partner_view.xml',
                    'views/sale_shop_view.xml',
                    'views/tms_agreement_travel_view.xml',
                    'views/tms_configuration_view.xml',
                    # 'views/tms_inherit_view.xml',
                    'views/tms_quotation_config_view.xml',
