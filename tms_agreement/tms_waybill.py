...
class tms_waybill(osv.osv):
    ...
    _columns = {        
        'agreement_origin': openerp.osv.fields.char('Source Agreement', size=256, help="Reference of the document that generated this agreement request.",readonly=True),
        'agreement': openerp.osv.fields.boolean('Agreement', readonly=True),
        'agreement_id': openerp.osv.fields.many2one('tms.agreement', 'Agreement Reference'),
    }
